...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#090D16] border-t border-slate-800/80 text-slate-400 text-xs py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="space-y-3 text-slate-300 font-medium">
              ...
              <p className="flex items-center gap-2">
                ...
                <span>Hazaribagh Main Town • Korrah • Matwari • Boddom Bazar • Canary Hill Road • Call Babu Chowk</span>
              </p>
            </div>
          </div>
        ...
        <div className="pt-6 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-slate-500">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="hover:text-indigo-400 transition-colors">Partner Registration</a>
          </div>
        </div>
