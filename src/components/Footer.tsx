...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-100 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 text-xs py-10 pb-28 sm:pb-12 transition-colors">
      <div className="max-w-5xl mx-auto px-4">
          ...
          <div>
            ...
            <div className="space-y-2 text-slate-600 dark:text-slate-400">
              <p className="flex items-center gap-2">
                ...
                <span className="font-semibold text-slate-900 dark:text-slate-100">1800-123-GHARTAK</span>
              </p>
              <p className="flex items-center gap-2">
        ...
        <div className="pt-6 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-slate-500 dark:text-slate-400">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Become a Partner</a>
          </div>
        </div>
