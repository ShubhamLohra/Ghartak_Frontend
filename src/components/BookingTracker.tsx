                  ...
                  <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-3.5 border border-slate-200 dark:border-slate-700 mb-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-slate-500 dark:text-slate-400">{b.provider.designation || b.provider.profession || 'Professional'} • ★ {b.provider.rating || 4.8} ({b.provider.completedJobs || 300}+ bookings)</p>
                      </div>
                    </div>
                    <a
